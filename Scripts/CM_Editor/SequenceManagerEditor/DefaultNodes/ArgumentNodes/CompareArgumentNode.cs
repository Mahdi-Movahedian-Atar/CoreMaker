...
{
    [Argument("CompareArgumentNode", "Default")]
    public class CompareArgumentNode : ArgumentParentNode
    {
        ...
        {
            if (argumentNodeData.IntArray == null || argumentNodeData.IntArray.Count != 3)
            { argumentNodeData.IntArray = new List<int>() { 0, 0, 0 }; }
            ...
            if (argumentNodeData.BoolArray == null || argumentNodeData.BoolArray.Count != 4)
            { argumentNodeData.BoolArray = new List<bool>() { false, false, false, false }; }

            NodeData = argumentNodeData;
            NodeData.TypeName = "CompareArgumentNode";
            //------------------------------------------------------------------------------------------------------------------------------------
            ...
            //------------------------------------------------------------------------------------------------------------------------------------
            extensionContainer
                .Add(SM_DropdownField(new List<string>() { "Int", "Float", "String", "Bool" }, argumentNodeData.IntArray[0], (index =>
                {
                    switch (index)
                    {
                        case "Int":
        ...
        public override ArgumentNodeData SaveNode()
        {
            ...
            {
                case 0:
                    if (!NodeData.BoolArray[0]) NodeData.IntArray[1] = ((IntegerField)_firstElement[0]).value;
                    else NodeData.StringArray[0] = ((TextField)_firstElement[0]).value;

                    if (!NodeData.BoolArray[1]) NodeData.IntArray[2] = ((IntegerField)_secondElement[0]).value;
                    else NodeData.StringArray[1] = ((TextField)_secondElement[0]).value;

                    break;

                case 1:
                    if (!NodeData.BoolArray[0]) NodeData.FloatArray[0] = ((FloatField)_firstElement[0]).value;
                    else NodeData.StringArray[0] = ((TextField)_firstElement[0]).value;

                    if (!NodeData.BoolArray[1]) NodeData.FloatArray[1] = ((FloatField)_secondElement[0]).value;
                    else NodeData.StringArray[1] = ((TextField)_secondElement[0]).value;

                    break;

                case 2:
                    NodeData.StringArray[0] = ((TextField)_firstElement[0]).value;

                    NodeData.StringArray[1] = ((TextField)_secondElement[0]).value;

                    break;

                case 3:
                    if (!NodeData.BoolArray[0]) NodeData.BoolArray[2] = ((Toggle)_firstElement[0]).value;
                    else NodeData.StringArray[0] = ((TextField)_firstElement[0]).value;

                    if (!NodeData.BoolArray[1]) NodeData.BoolArray[3] = ((Toggle)_secondElement[0]).value;
                    else NodeData.StringArray[1] = ((TextField)_secondElement[0]).value;
        ...
        public override SequenceManagerElementData CreateArgument()
        {
            ...
            {
                Type = typeof(CompareArgument<int>).ToString(),
        ...
        private void _setFirst()
        {
            ...
            else
            {
                ...
                {
                    case 0:
                        _firstElement.Add(SM_IntField(NodeData.IntArray[1]));
                        break;
                    case 1:
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        _firstElement.Add(SM_Toggle(NodeData.BoolArray[2]));
                        break;
                }
        ...
        private void _setSecond()
        {
            ...
            else
            {
                ...
                {
                    case 0:
                        _secondElement.Add(SM_IntField(NodeData.IntArray[2]));
                        break;
                    case 1:
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        _secondElement.Add(SM_Toggle(NodeData.BoolArray[3]));
                        break;
                }
