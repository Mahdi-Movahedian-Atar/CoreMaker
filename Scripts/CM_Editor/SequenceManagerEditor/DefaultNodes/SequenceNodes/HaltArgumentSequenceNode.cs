...
{
    [Sequence("HaltArgumentSequenceNode", "Default")]
    public class HaltArgumentSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "HaltArgumentSequenceNode";
        }
        ...
        public override SequenceManagerElementData CreateSequence()
        {
            ...
            {
                Type = typeof(HaltArgumentSequence).ToString(),
