...
{
    [Sequence("HaltAllArgumentsSequenceNode", "Default")]
    public class HaltAllArgumentsSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            NodeData.TypeName = "HaltAllArgumentsSequenceNode";
        }
        ...
        {
            return new SequenceManagerElementData { Type = typeof(HaltAllArgumentsSequence).ToString() };
        }
    }
}
