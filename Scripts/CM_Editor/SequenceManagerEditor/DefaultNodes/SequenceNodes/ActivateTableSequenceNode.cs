...
{
    [Sequence("ActivateTableSequenceNode", "Default")]
    public class ActivateTableSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "ActivateTableSequenceNode";
        }
        ...
        public override SequenceManagerElementData CreateSequence()
        {
            ...
            {
                Type = typeof(ActivateTableSequence).ToString(),
