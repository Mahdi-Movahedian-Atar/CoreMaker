...
{
    [Sequence("DeactivateTableSequenceNode", "Default")]
    public class DeactivateTableSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "DeactivateTableSequenceNode";
        }
        ...
        public override SequenceManagerElementData CreateSequence()
        {
            ...
            {
                Type = typeof(DeactivateTableSequence).ToString(),
