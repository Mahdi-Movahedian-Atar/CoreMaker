...
{
    [Sequence("StartAllArgumentsSequenceNode", "Default")]
    public class StartAllArgumentsSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            NodeData.TypeName = "StartAllArgumentsSequenceNode";
        }
        ...
        {
            return new SequenceManagerElementData { Type = typeof(StartAllArgumentsSequence).ToString() };
        }
    }
}
