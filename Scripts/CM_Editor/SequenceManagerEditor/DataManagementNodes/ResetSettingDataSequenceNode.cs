...
{
    [Sequence("ResetSettingDataSequenceNode", "Data Management")]
    public class ResetSettingDataSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "ResetSettingDataSequenceNode";
        }
        ...
        public override SequenceManagerElementData CreateSequence()
        {
            return new SequenceManagerElementData()
            {
                ...
                Type = typeof(ResetSettingDataSequence).ToString()
            };
        }
    }
}
