...
{
    [Sequence("LoadSettingDataSequenceNode", "Data Management")]
    public class LoadSettingDataSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "LoadSettingDataSequenceNode";
        }
        ...
        public override SequenceManagerElementData CreateSequence()
        {
            return new SequenceManagerElementData()
            {
                ...
                Type = typeof(LoadSettingDataSequence).ToString()
            };
        }
    }
}
