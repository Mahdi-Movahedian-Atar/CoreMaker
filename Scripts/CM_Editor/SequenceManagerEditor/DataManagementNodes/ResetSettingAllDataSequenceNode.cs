...
{
    [Sequence("ResetSettingAllDataSequenceNode", "Data Management")]
    public class ResetSettingAllDataSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "ResetSettingAllDataSequenceNode";
        }
        ...
        {
            return new SequenceManagerElementData() { Type = typeof(ResetSettingAllDataSequence).ToString() };
        }
    }
}
