...
{
    [Sequence("LoadDataSequenceNode", "Data Management")]
    public class LoadDataSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "LoadDataSequenceNode";
        }
        ...
        public override SequenceManagerElementData CreateSequence()
        {
            return new SequenceManagerElementData()
            {
                ...
                Type = typeof(LoadDataSequence).ToString()
            };
        }
    }
}
