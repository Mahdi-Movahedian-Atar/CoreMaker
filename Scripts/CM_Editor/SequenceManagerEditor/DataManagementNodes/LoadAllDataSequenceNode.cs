...
{
    [Sequence("LoadAllDataSequenceNode", "Data Management")]
    public class LoadAllDataSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "LoadAllDataSequenceNode";
        }
        ...
        {
            return new SequenceManagerElementData() { Type = typeof(LoadAllDataSequence).ToString() };
        }
    }
}
