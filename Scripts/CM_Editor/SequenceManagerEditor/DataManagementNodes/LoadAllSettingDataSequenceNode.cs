...
{
    [Sequence("LoadAllSettingDataSequenceNode", "Data Management")]
    public class LoadAllSettingDataSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "LoadAllSettingDataSequenceNode";
        }
        ...
        {
            return new SequenceManagerElementData() { Type = typeof(LoadAllSettingDataSequence).ToString() };
        }
    }
}
