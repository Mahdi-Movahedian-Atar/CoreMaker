...
{
    [Sequence("SaveAllDataSequenceNode", "Data Management")]
    public class SaveAllDataSequenceNode : SequenceParentNode
    {
        ...
        public override void CreateNode(SequenceNodeData sequenceNodeData)
        {
            ...
            sequenceNodeData.TypeName = "SaveAllDataSequenceNode";
        }
        ...
        {
            return new SequenceManagerElementData() { Type = typeof(SaveAllDataSequence).ToString() };
        }
    }
}
